...
namespace DAPM.OperatorMS.Api
{
    public class OperatorEngine : IOperatorEngine
    {
        ...
        {
            var operatorExecution = new OperatorExecution(this, message.TicketId, message.PipelineExecutionId, message.OutputResourceId, message.InputResourceIds, message.SourceCode, message.Dockerfile, _dockerService);
